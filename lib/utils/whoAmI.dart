      ...
      case "ROLE_ADMIN":
        {
          ...
          navigationList.add(
              NavigationName(buttonName: "Staff", buttonRoute: "Admin/Staff"));
          navigationList.add(
              NavigationName(buttonName: "Rooms", buttonRoute: "Admin/Rooms"));
          navigationList
              .add(NavigationName(buttonName: "Guest", buttonRoute: "Guest"));
      ...
      case "ROLE_CLIENT":
        {
          ...
          navigationList.add(
              NavigationName(buttonName: "Stay", buttonRoute: "Guest/Stay"));
          return navigationList;
        }
      case "ROLE_KITCHEN":
        {
